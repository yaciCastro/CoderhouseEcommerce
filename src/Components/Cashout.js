        ...
        auth.onAuthStateChanged(user => {
            if (user) {
                ...
                db.collection('Buyer-info ' + user.uid).doc('_' + time).set({
                    ...
                    setAddress('');
                    dispatch({ type: 'EMPTY' })
                    setSuccessMsg('Tu orden fue recibida correctamente. Gracias por visitarnos. Seras redireccionado a la pagina principal en 5 segundos');
                    setTimeout(() => {
                        history.push('/')
                    }, 5000)
        ...
        <>
            ...
            <div className='container'>
                ...
                <form autoComplete="off" className='form-group' onSubmit={cashoutSubmit}>
                    ...
                    <br />
                    <label htmlFor="Delivery Address">Direccion de envio</label>
                    <input type="text" className='form-control' required
                    ...
                    <br />
                    <label htmlFor="Total No of Products">Total</label>
                    <input type="number" className='form-control' required
